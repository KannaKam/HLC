...
var eventoController = /** @class */ (function () {
    ...
    eventoController.prototype.traerEventos = function (req, resp) {
        event_model_1.Evento.find().then(function (eventDB) {
            if (!eventDB) {
    ...
    eventoController.prototype.eliminarEvento = function (req, resp) {
        var params = req.body;
        event_model_1.Evento.deleteOne({ "_id": params._id }).then(function () {
            resp.status(200).send({
                status: "ok",
    ...
    eventoController.prototype.crearEvento = function (req, resp) {
        var params = req.body;
        var event = new event_model_1.Evento();
        ...
        event_model_1.Evento.create(event).then(function () {
            resp.status(200).send({
                status: "ok",
    ...
    eventoController.prototype.actualizarEvento = function (req, resp) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                params = req.body;
                event_model_1.Evento.findOne({ _id: params._id }).then(function (eventDB) {
                    if (!eventDB) {
                        return resp.status(200).send({
                            status: "error",
